...
11:00-12:00    Morning session I, Collyer - in other time zones
Administrivia
1 min - Blue sheets / scribe selection / NOTE WELL

1 min - Agenda bashing

## 3 min - Contribution policy

modify to align with quic and enable editors to work more effectively

## Proposed Work

10 min - Secondary Certificates - Mike Bishop (presentation)
...
fair number of folks have read it.
...
## 10 min - Bootstrapping WebSockets with HTTP/2 - Patrick McManus (presentation)
...
## 10 min - HTTPter scope of work - Mark Nottingham
...
Patrick: gauging interest. not many hands. humm: twice as much humming for pursuing this.

Related Work (time permitting)

10 min - Variants - Mark Nottingham (presentation)
...
Brian Coll (?): looks good to know what variants are supported at the server
...
## 10 min - 451 New Protocol Elements - Shivan Sahib (presentation)
...
10 min - HTTP payments - Adrian Hope-Bailie (presentation)
...
Yoav: Tried to analyze the risks and potential mitigations.  Mitigating attacks across origin is the simplest, the client can say that's illegal.  
...
MT: Patrick summarized this from the outset, lots of uncertainty here.  

Ian Swett:  Do we have an idea of how well shared dictionaries work compared to cross-stream compression?

Yoav: They addresss different use cases.  Shared dictionaries work well for large websites with similar content.  His proposal addresses 'bundling' use cases where resources compress really well bundled together.
Out of band shared dictionaries can give better performance, but are not necissarily as good in all cases.
