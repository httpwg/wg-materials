9:00-11:00 Tuesday Morning session I, Chitlada I - other time zones
...
HTTP Core
10 min - Editors’ update - Julian Reschke (presented by Mark Nottingham)
102 min - Issue discussion (list)
...
## Active Extension Drafts (This is the Thursday session)

Administrivia:

(applause for Tommy)

5 min - CDN Loop Prevention
...
5 min - Variants - Mark Nottingham
...
5 min - Cache Digests for HTTP/2
...
5 min - RFC6265bis: Cookies

(nothing)

## QUIC and HTTP
20 min - HTTP and QUIC Updates - Mike Bishop
...
15 min - HTTP/2 as Transport - Eric Kinnear
...
10 min - Cache Header - Mark Nottingham
