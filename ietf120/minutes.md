...
- [Wednesday, 24 July 2024](#wednesday-24-july-2024)
  - [Security Considerations for Optimistic Use of HTTP Upgrade](#security-considerations-for-optimistic-use-of-http-upgrade)
    ...
    - [Slide 7](#slide-7)
    - [Slide 8](#slide-8)
  - [HTTP Server Secondary Cert Auth](#http-server-secondary-cert-auth)
    - [Slide 3](#slide-3)
    - [Slide 4](#slide-4)
  - [The HTTP Wrap Up Capsule](#the-http-wrap-up-capsule)
  - [No-Vary-Search](#no-vary-search)
    - [Mic](#mic)
  - [Revising Cookies Again](#revising-cookies-again)
    - [Mic](#mic-1)
  - [HTTP Resource Versioning](#http-resource-versioning)
