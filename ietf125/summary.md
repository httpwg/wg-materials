...
- [Session Summary: 20260320-0100](#session-summary-20260320-0100)
- [HTTPBIS](#httpbis)
  - [Summary](#summary)
  - [Key Discussion Points](#key-discussion-points)
    - [HTTP Redirect Headers](#http-redirect-headers)
    - [HTTP Signature-key Header](#http-signature-key-header)
    - [Preliminary Request Denied](#preliminary-request-denied)
    - [CONNECT-TCP](#connect-tcp)
    - [Unbound DATA for CONNECT in HTTP/3](#unbound-data-for-connect-in-http3)
    - [Resumable Uploads](#resumable-uploads)
    - [MOQPACK](#moqpack)
    - [HTTP Wrap-up Capsule](#http-wrap-up-capsule)
